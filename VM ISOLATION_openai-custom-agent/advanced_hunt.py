...
import EXECUTOR
import GUARDRAILS
import ADVANCED_PROMPT_MANAGEMENT
import ADVANCED_EXECUTOR
...
user_message = ADVANCED_PROMPT_MANAGEMENT.get_user_message() #TODO: Remove comment
...
unformatted_query_context = ADVANCED_EXECUTOR.get_query_context(openai_client, user_message, model=model)
...
law_query_results = ADVANCED_EXECUTOR.query_log_analytics(
    ...
    account_name=query_context["account_name"],
...
threat_hunt_user_message = ADVANCED_PROMPT_MANAGEMENT.build_threat_hunt_prompt(
...
threat_hunt_system_message = ADVANCED_PROMPT_MANAGEMENT.SYSTEM_PROMPT_THREAT_HUNT
...
hunt_results = ADVANCED_EXECUTOR.hunt(
